...
@st.cache() # whenever the function is called, the result is cached
...
['About App','Run on Image','Run on Video', 'Holistic']
)
...
if app_mode =='About App':
    ...
    codec = cv2.VideoWriter_fourcc('V','P','8','0') # VP80, can be changed to VP09
    out = cv2.VideoWriter('output1.mp4', codec, fps_input, (width, height))
    ...
    with mp_holistic.Holistic(
        ...
        for idx, file in enumerate(IMAGE_FILES):
            ...
            if results.pose_landmarks:
                print(
                    f'Nose coordinates: ('
                    f'{results.pose_landmkarks.landmark[mp_holistic.PoseLandmark.NOSE].x * image_width}, '
